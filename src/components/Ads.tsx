...
export const AdMobBanner = ({ bannerSize = 'fullBanner' }) => {
	...
	return (
		<AdMobBannerComponent
			bannerSize={bannerSize as 'banner' | 'fullBanner' | 'largeBanner' | 'leaderboard' | 'mediumRectangle' | 'smartBannerLandscape' | 'smartBannerPortrait'} // Banner size (banner | fullBanner | largeBanner | leaderboard | mediumRectangle | smartBannerLandscape | smartBannerPortrait)
